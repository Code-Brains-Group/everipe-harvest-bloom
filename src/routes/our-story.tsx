    ...
    <>
      ...
      <section className="py-28 md:py-36 bg-cream">
        <div className="container-x grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="reveal">
            ...
            <h2 className="font-serif text-4xl md:text-5xl leading-tight mb-8">Yields increased. <em className="italic-accent">But something was still wrong.</em></h2>
      ...
      <section className="bg-teal text-white py-32 md:py-40 text-center">
        <div className="container-x reveal">
          <h2 className="font-serif text-4xl md:text-7xl leading-tight max-w-4xl mx-auto">Bumper harvests <em className="italic">became losses.</em></h2>
      ...
      <section className="py-32 md:py-44 bg-cream text-center">
        <div className="container-x max-w-4xl reveal">
          <p className="font-serif italic text-3xl md:text-5xl leading-tight">"What if protection could be as simple as <span className="italic-accent">a spray?"</span></p>
        </div>
      </section>
      ...
      <section className="py-28 md:py-36 bg-white">
        <div className="container-x grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="reveal">
            ...
            <h2 className="font-serif text-4xl md:text-5xl leading-tight mb-8">It was <em className="italic-accent">TAEC.</em></h2>
